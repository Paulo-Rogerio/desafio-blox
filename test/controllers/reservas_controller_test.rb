...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { evento: @reserva.evento, inicio: @reserva.inicio, sala_id: @reserva.sala_id, termino: @reserva.termino, user_id: @reserva.user_id } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { evento: @reserva.evento, inicio: @reserva.inicio, sala_id: @reserva.sala_id, termino: @reserva.termino, user_id: @reserva.user_id } }
